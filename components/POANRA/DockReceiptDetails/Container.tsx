...
import { IDockReceipt_FORM, IDockReceipt_Response, IEffectSection } from "../../../Types/dockReceiptTypes";
...
const Container = ({
  ...
  useEffect(() => {
    const fetch = async () => {
      console.log("I am at container")
      console.log("Id:"+formValues.customer_id)
      
      setIsLoading(true);
      const { data, count }: any = await fetchContainerByCustomerId(formValues.customer_id, offset, rowsPerPage);
