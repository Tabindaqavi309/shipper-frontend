...
const CustomerForm = ({ formValues, setFormValues,customerId, customerName, setConsigneeIsVisible, setConsigneeData, setBookingData }: IProps) => {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      ...
      const bookingResponse: IBookingDropDownData[] = await findBookingByCustomerId(customerId);
