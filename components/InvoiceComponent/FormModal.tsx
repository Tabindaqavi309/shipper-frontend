...
const FormModal = ({
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (formAction === "edit") {
        await handleUpdateInvoice_Receipt_API(formValues, formValues.customer_id);
      } else {
  ...
  useEffect(() => {
    if (formAction === "edit") {
      ...
      fetchDockReceiptByCustomerId(customer_id).then((data) => setDockReceiptData(data));
  ...
  const renderView = () => {
    const view = (
      <div>
        <DockReceiptsDropDown formValues={formValues} setFormValues={setFormValues} dockReceiptData={dockReceiptData} />
      </div>
    );
  ...
  return (
    <Modal size={size} open={open} onClose={closeModal}>
      ...
      <Modal.Content scrolling>
        ...
        />
        {renderView()}
        <Details formAction={formAction} formValues={formValues} setFormValues={setFormValues} />
      </Modal.Content>
      <Modal.Actions>
