...
export const consigneeFullTextSearchAPI = async (inputValue: string) =>
  new Promise((resolve, reject) => {
    ...
    axios
      .post(`${customerSrv}/api/customer-srv/consignee/full-text-search`, reqBody, { headers })
      .then(({ data }) => {
        resolve(data);
      })
      .catch(({ response }) => {
...
export const handleSaveAPI = async (formValues: IConsigneeForm) => {
  return new Promise((resolve, reject) => {
    ...
    axios
      .post(`${customerSrv}/api/customer-srv/consignee`, formValues, { headers })
      .then(({ data }) => {
        resolve(data);
      })
      .catch(({ response }) => {
...
export const fetchConsignee = async (offset: number, limit: number) =>
  new Promise((resolve, reject) => {
    ...
    axios
      .get(`${customerSrv}/api/customer-srv/consignee?offset=${offset}&limit=${limit}`, { headers })
      .then(({ data }) => {
        resolve(data);
      })
      .catch(({ response }) => {
...
export const handleUpdateAPI = async (objToSave: any) => {
  return new Promise((resolve, reject) => {
    ...
    axios
      .put(`${customerSrv}/api/customer-srv/consignee/` + id, objToSave, { headers })
      .then(({ data }) => {
        resolve(data);
      })
      .catch(({ response }) => {
...
export const handleDeleteConsigneeApi = async (consigneeId: number) => {
  return new Promise((resolve, reject) => {
    ...
    axios
      .delete(`${customerSrv}/api/customer-srv/consignee/` + consigneeId, { headers })
      .then(({ data }) => {
        resolve(data);
      })
      .catch(({ response }) => {
