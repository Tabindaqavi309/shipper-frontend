  ...
  return (
    <div>
      ...
      <body>
        <br />
        {!isLoading && (
          <div id="element-to-print" className="element-to-print">
            <div className="container">
              ...
              <div className="row" style={{ fontSize: 18 }}>
                ...
                <div className="col-md-2" style={{ border: "1px solid #000" }}>
                  <div className="row">
                    <div style={{ padding: 7 }}>
                      <div style={{ marginTop: 5, height: 564, fontSize: 20 }}>
                        {carRow.map((result, index) => (
                ...
                <div className="col-md-2" style={{ border: "1px solid #000" }}>
                  <div className="row">
                    <div style={{ paddingLeft: 7, marginTop: 13 }}>
                      <div>
                        {carRow.map((result, index) => (
                          <div style={{ textAlign: "left" }} key={index}>
                            <span>
              ...
              <div className="row">
                <div className="col-md-5" style={{ fontSize: 15 }}>
                  <span>LIGHTER TRUCK _________________</span>
                  <br />
                  <br />
                  <span>ARRIVED DATE____________ TIME_______</span>
                  <br />
                  <br />
                  <span>UNLOADED DATE_______ TIME_____</span>
                  <br />
                  <br />
