          ...
          <div className="container">
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <div className="h_2">
                    ...
                    <br />
                    <span>
                      <b>Company address:</b> 13903 CHADSWORTH TERRACE,\nLaurel, MD 20707, USA
                    </span>
                    <br />
                    <span>
            ...
            <table style={{ width: "100%" }}>
              <tr>
                ...
                <td colSpan={6}>
                  ...
                  <br />
                  <br />
                  <span style={{ fontSize: 25, fontWeight: "lighter" }}>{row.carrier}</span>
                </td>
              </tr>
            </table>
            ...
            <table style={{ width: "100%" }}>
              <tr>
                ...
                <td>{row.sail_date !== null ? moment(row.sail_date).format("l") : ""}</td>
                <td>
                  <b>Arrival/ETA</b>
                </td>
                <td>{row.arrival_date !== null ? moment(row.arrival_date).format("l") : ""}</td>
              </tr>
              <tr>
                <td>
                  <b>Pickup Terminal</b>
            ...
            <span>
              Container Needs To Return To The Port 5 Days From Delivery,after Per Diem Charges Of $135/ Day Applies. Once The Container Is Loaded
              Please Provide Us With Container #, Seal #, Pieces Count & Weight
            </span>
          </div>
        </div>
